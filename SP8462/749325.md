[题目传送门](https://www.luogu.com.cn/problem/SP8462)

[更好的阅读体验](https://www.luogu.com.cn/blog/sincerin520/solution-sp8462)

顺带一提，这题和[P1937](https://www.luogu.com.cn/problem/P1937)是重题。
...
既然这样，我们考虑来把这个过程转换成减法，每次操作把对应的 $C_i (i \in [A_i,B_i])$ 都减去 $1$，表示每个畜栏还能住的牛的头数。这样在判断是否可以满足请求区间的时候，只需要确保区间的最小值 $\min \{C_{A_i} \dots C_{B_i} \} \geq 1$ 即可。区间修改 $+$ 区间最小值查询，很明显可以用一棵[线段树](https://www.cnblogs.com/xenny/p/9801703.html)来维护最小值。
...
[AC Record（最优解第五哦）](https://www.luogu.com.cn/record/100240536)
