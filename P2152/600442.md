~~某个人花了两个小时写的暴力高精gcd交上去超时，是谁我不说。~~

前置知识：[更相减损术](https://baike.baidu.com/item/%E6%9B%B4%E7%9B%B8%E5%87%8F%E6%8D%9F%E6%9C%AF/449183?fr=aladdin)
...
对于最简单的更相减损术模拟，常数过大，会炸掉。

这时，我们可以根据以下三条性质，进行优化即可。

- 当 $a$ 是偶数，$b$ 是偶数时，$\gcd(a,b)=\gcd(\dfrac{a}{2},\dfrac{b}{2})\times 2$。

- 当 $a$ 是偶数，$b$ 是奇数时，$\gcd(a,b)=\gcd(\dfrac{a}{2},b)$。

- 当 $a$ 是偶数，$b$ 是奇数时，$\gcd(a,b)=\gcd(a,\dfrac{b}{2})$。
