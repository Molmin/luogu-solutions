思路和楼上的基本一样. 上面的楼主用的叉积的正负判断三角形是否合法,十分巧妙. 

这里提供一种更简单也更容易想到的方法: 判断是否有一个点在三角形内部, 如果一个

点在内部, 三角形的三个端点连接内部这个点, 将面积分为了3部分, 判断这3部分相

加是否等于原三角形面积. 相等说明有点在内部.

代码加了比较详细的注释, 方便初学者学习

```cpp
/*
 * Created by xxxx on 2019-10-20
 *
 */
