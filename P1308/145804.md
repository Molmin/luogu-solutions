...
```
这里主要是了解到了tranform这个函数 详解在https://blog.csdn.net/enterprise_/article/details/78177880
和https://zh.cppreference.com/w/cpp/algorithm/transform里 非常好用hh