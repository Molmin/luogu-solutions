## 提醒
因本题语言限制，请使用 `C++98` 提交，感谢 [Sprague_Garundy](https://www.luogu.com.cn/user/764746) 的贡献。
### 总体思路
...
## 代码
[AC 记录](https://www.luogu.com.cn/record/115383303)
```cpp
#include<bits/stdc++.h>
...
bool panduan(int x) {
	...
	if(y[x - 1] == y[x]) {
		if(m[x - 1] == m[x]) {
			...
			if(runnian_check(y[x]))month[2]++;//更改闰年
