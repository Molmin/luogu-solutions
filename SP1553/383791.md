...
先读题，肯定要选相邻的，然后将这道题转化一下，将路段长度作为选择对象，就成了这个样子：

~~~~
在 n-1 个路段里选择 k 个不相邻的路段，使得路段长度总和最小。
~~~~
...
int n,m,a[100005],tot,flag[100005],nxt[100005],lst[100005],s[100005];
struct node{
	int id,x;
