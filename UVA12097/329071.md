[点我看题](https://www.luogu.com.cn/problem/UVA12097)

双倍经验[SP1837](https://www.luogu.com.cn/problem/SP1837)！
...
- $1.$ 这道题会卡精度， $π$ 的值一定要精确。对此，我们可以用 $cmath$ 库里的黑科技“M_PI”（表示π的近似值），精度能够达到本题要求；

- $2.$ 注意，我自己也要吃一块派，所以人数要+1!
